...
====================================
        Main Menu
====================================
1: Disable Sleep Settings
2: Remove Office 365 Bloatware
3: Remove Dell Bloatware 1
4: Remove Dell Bloatware 2
5: Deploy Adobe Reader
6: Deploy Microsoft Remote Desktop Client
7: Deploy Zoom
8: Deploy Chrome
9: Deploy 7-Zip
100: Exit
